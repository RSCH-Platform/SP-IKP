            ...
            <div class="px-6 py-4 space-y-8 bg-white">
                ...
                <div x-data="{ openWhyModal: false }">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex flex-col items-center mt-1">
                                    <div class="w-6 h-6 flex items-center justify-center text-xs font-bold rounded-full
                        {{ $isRoot 
                    ...
                    <div
                        ...
                        {{-- Modal Content --}}
                        <div
                            class="relative w-full max-w-lg mx-4 p-4 border border-blue-300 dark:border-blue-700 rounded-lg bg-white dark:bg-slate-800">

                            <h5 class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">
                                {{ isset($whyFormData['id']) 
                    ? '✎ Edit WHY' 
                    : '➕ Tambah WHY ke-' . (count($problem['whys'] ?? []) + 1) }}
                            </h5>
                            ...
                            <textarea
                                ...
                                class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-slate-600 rounded-md bg-white dark:bg-slate-800 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </textarea>
                ...
                <div class="space-y-3 border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        @foreach($problem['contributors'] as $index => $contrib)
                        <div class="p-4 border border-purple-200 rounded-lg bg-purple-50 hover:bg-purple-100 transition">
