        ...
        <div class="relative">
            ...
            <div class="space-y-10">
                ...
                <div class="relative flex items-start gap-6">
                    ...
                    {{-- node icon --}}
                    @php
                    $iconClass = match($this->stepStatus($step['key'])) {
                    'done' => 'step-icon-done',
                    ...
                    @endphp
                    <div class="{{ $iconClass }}">
                        @if($this->shouldShowCheckmark($step['key']))
                    ...
                    <div class="relative flex-1 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <span class="step-badge-done">selesai</span>
                            @elseif($this->stepStatus($step['key']) === 'current')
                            <span class="step-badge-current">proses</span>
                            @endif
                        </div>
