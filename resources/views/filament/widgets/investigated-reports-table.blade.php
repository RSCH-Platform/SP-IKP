    ...
    <div
        ...
        <div class="border-b border-slate-200 px-5 py-4 dark:border-white/10">
            ...
            <details class="group mt-4">
                <summary
                    class="flex cursor-pointer list-none items-center justify-between rounded-md border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100 dark:border-white/10 dark:bg-white/[0.03] dark:text-slate-200 dark:hover:bg-white/[0.06]">
                ...
                <div
                    class="mt-3 rounded-md border border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-slate-900">
        ...
        <div class="p-4">
            <x-report-table tableClass="min-w-[1600px]"
                scrollClass="max-w-full rounded-md border border-slate-200 dark:border-white/10">
                <x-slot:colgroup>
                    <colgroup>
                        <col class="w-[8%]">
                        <col class="w-[28%]">
